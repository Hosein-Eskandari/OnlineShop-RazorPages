...
public static class Tools
{
    ...
    {
        if (date == new DateTime()) return "";
         var result = $"{date.Year}/{date.Month:00}/{date.Day:00} {date.Hour:00}:{date.Minute:00}:{date.Second:00}";
         return result;
    }
    ...
    public static DateTime ToGeorgianDateTime(this string persianDate)
    {
        ...
        var hour = Convert.ToInt32(persianDate.Substring(0, 2));
        var minute = Convert.ToInt32(persianDate.Substring(3, 2));
        var second = Convert.ToInt32(persianDate.Substring(6, 2));
        var year = Convert.ToInt32(persianDate.Substring(9, 4));
        var month = Convert.ToInt32(persianDate.Substring(14, 2));
        var day = Convert.ToInt32(persianDate.Substring(17, 2));
        return new DateTime(year, month, day, hour, minute, second, new PersianCalendar());
    }

    //public static DateTime ToGeorgianDateTimeSchedule(this string persianDate)
    //{
    //    persianDate = persianDate.ToEnglishNumber();
    ...
    //    var minute = Convert.ToInt32(persianDate.Substring(3, 2));
    //    var second = Convert.ToInt32(persianDate.Substring(6, 2));
    //    var year = Convert.ToInt32(persianDate.Substring(8, 4));
    //    var month = Convert.ToInt32(persianDate.Substring(13, 2));
    //    var day = Convert.ToInt32(persianDate.Substring(16, 2));
